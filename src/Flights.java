public class Flights {
    ...
    public void defaultFlights() {
        ...
        flightsInfo[1] = new Flight("WZ-15", "Yazd", "Tehran", "1402-2-12", "08:30", "900000", "220");
    ...
    public void addFlights(String flightId, String origin, String destination, String date, String time, String price, String seats) {
        flightsInfo[3 + countFlights] = new Flight(flightId, origin, destination, date, time, price, seats);
        countFlights++;
    }
    ...
    public void removeFlights(int index) {
        for (int i = index; i < 4 + countFlights; i++)
